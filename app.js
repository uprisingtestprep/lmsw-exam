/* LMSW Exam Simulator, Application Logic */

const ACCESS_CODE  = "LMSW9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "lmsw_exam_state_v1";
const SIM_Q_COUNT  = 122;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"values_and_ethics": "Values and Ethics", "assessment_and_planning": "Assessment and Planning", "intervention_and_practice": "Intervention and Practice"};  // maps domain key -> human-readable label for display
